...
import './StudentDashboardModern.css';
...
const StudentDashboardModern = () => {
  ...
  const pageTitles = {
    ...
    'profile': { title: 'Profil', desc: 'Gérer votre profil personnel' },
      ...
      <div className="main-content">
        ...
        <header className="main-header">
          <div className="header-left">
            <h1 className="page-title">{pageTitles[activeSection].title}</h1>
            <p className="page-description">{pageTitles[activeSection].desc}</p>
          </div>
        ...
        <main className="content">
                ...
                <div className="chart-container">
                  ...
                  <div className="chart-content">
                    <div className="chart-placeholder">
                      ...
                      <p>Graphique de progression des tests</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="chart-section">
                ...
                <div className="chart-container">
                  <div className="chart-placeholder">
                    ...
                    <p>Graphique d'évolution des candidatures</p>
                  </div>
                </div>
              </div>
                            ...
                            {rec.reasons.map((reason, index) => (
                              <li key={index}>
                                ...
                                <span className="reason-text">
                                  <strong>{reason.split(' ').slice(0, 4).join(' ')}</strong> {reason.split(' ').slice(4).join(' ')}
                                </span>
                              </li>
                            ))}
                          </ul>
                ...
                <div className="profile-card">
                  <div className="profile-header">
                    ...
                    <div className="profile-info">
                      <h3>Fatima Zahra</h3>
                      <p>fatima.zahra@gmail.com</p>
                      <span className="profile-role">Étudiante</span>
                    </div>
                  </div>
                  <div className="profile-details">
                    <div className="detail-group">
                      ...
                      <div className="detail-item">
                        ...
                        <span className="value">Fatima Zahra</span>
                      </div>
                      <div className="detail-item">
                        <span className="label">Email:</span>
                        <span className="value">fatima.zahra@gmail.com</span>
                      </div>
                      <div className="detail-item">
                        <span className="label">Date d'inscription:</span>
                        <span className="value">15 Janvier 2024</span>
                      </div>
                    </div>
                    <div className="detail-group">
                      <h4>Statistiques</h4>
                      <div className="detail-item">
                        <span className="label">Tests complétés:</span>
                      ...
                      <div className="detail-item">
                        <span className="label">Programmes sauvegardés:</span>
          ...
          {/* Other Sections */}
          {!['overview', 'applications', 'results', 'profile'].includes(activeSection) && (
            <div className="dashboard-content">
