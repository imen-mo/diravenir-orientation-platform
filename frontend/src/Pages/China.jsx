  ...
  const universities = [
    {
      ...
      image: "https://via.placeholder.com/300x200/4F46E5/FFFFFF?text=Tsinghua"
    },
    {
      ...
      image: "https://via.placeholder.com/300x200/7C3AED/FFFFFF?text=Peking"
    },
    {
      ...
      image: "https://via.placeholder.com/300x200/059669/FFFFFF?text=SJTU"
    }
  ];
  ...
  const workInfo = [
    {
      ...
      opportunities: "Teaching English, Translation, Research Assistant"
    },
    {
      title: "Internships",
      description: "Many universities offer internship programs with local companies",
      requirements: "Good academic standing, language skills",
      opportunities: "Tech companies, Multinational corporations, Research institutes"
    },
    {
      title: "Post-graduation Work",
      description: "Graduates can apply for work permits in China",
      requirements: "Bachelor's degree, job offer, Chinese company sponsorship",
      opportunities: "Technology, Finance, Education, Trade"
    }
  ];
  ...
  const schedule = [
    {
      ...
      activities: "Core courses, Language classes, Cultural orientation"
    },
    {
      period: "Winter Break",
  ...
  return (
    <GlobalLayout activePage="programs">
      <div className="country-page">
        ...
        <div className="hero-section" style={{ backgroundImage: `url(${chinaImage})` }}>
          <div className="hero-overlay">
            <div className="hero-content">
              <h1>Study in China</h1>
              <p>Discover the world's fastest-growing economy and ancient culture</p>
      ...
      <div className="tab-content">
          ...
          <div className="overview-section">
            <div className="overview-grid">
              <div className="overview-card">
                <h3>Why Study in China?</h3>
                <ul>
                  <li>World-class education at affordable costs</li>
                  <li>Rapidly growing economy and job opportunities</li>
                  <li>Rich cultural heritage and modern cities</li>
                  <li>Strong focus on technology and innovation</li>
                  <li>Growing international business presence</li>
                </ul>
              </div>
              <div className="overview-card">
                ...
                <div className="cost-item">
                  ...
                  <span>¥1,500 - ¥3,000/month</span>
                </div>
                <div className="cost-item">
                  <span>Food:</span>
                  <span>¥1,000 - ¥2,000/month</span>
                </div>
                <div className="cost-item">
                ...
                <div className="cost-item">
                  <span>Total:</span>
                  <span>¥3,000 - ¥6,000/month</span>
                </div>
              </div>
              <div className="overview-card">
                <h3>Language Requirements</h3>
                <p>Most programs are available in English, but learning Chinese (Mandarin) is highly recommended for:</p>
                <ul>
                  <li>Better cultural integration</li>
                  <li>More job opportunities</li>
                  <li>Daily life convenience</li>
                  <li>Understanding local culture</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        {activeTab === 'universities' && (
          <div className="universities-section">
            <h2>Top Universities in China</h2>
      ...
      <div className="cta-section">
        <div className="cta-content">
          <h2>Ready to Start Your Journey in China?</h2>
          <p>Join thousands of international students already studying in China</p>
