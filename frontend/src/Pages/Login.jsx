    ...
    const handleSubmit = async (e) => {
        ...
        if (result.success) {
            ...
            if (userRole === 'ADMIN') {
                ...
                navigate('/', { replace: true }); // ✅ Autres → Homepage
            }
        }
    };
            ...
            <div className="login-layout">
                    ...
                    <div className="login-form-container">
                        ...
                        <form className="login-form" onSubmit={handleSubmit}>
                            ...
                            <div className="login-separator">
                                <span className="login-separator-text">ou</span>
                            </div>
                ...
                <div className="login-illustration-section">
                    ...
                    <div className="login-illustration-content">
                        ...
                        />
                        <h3 className="login-illustration-title">🚀 Découvrez votre avenir</h3>
                        <p className="login-illustration-text">
                            Connectez-vous et explorez votre orientation avec Diravenir
                        </p>
                    </div>
                </div>
            </div>
