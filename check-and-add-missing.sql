-- Script intelligent pour ajouter seulement les colonnes qui manquent vraiment
-- Évite les erreurs de colonnes dupliquées
...
SELECT '=== TABLES ORIENTATION FINALES ===' AS Info;
