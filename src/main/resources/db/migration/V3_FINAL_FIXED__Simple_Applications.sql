-- Migration V3 FINAL FIXED: Simple Applications Structure - Sans erreurs MySQL
-- Ce script évite l'erreur "TEXT column can't have default value"
...
CREATE TABLE IF NOT EXISTS applications (
    ...
    -- Home Address Details (SANS DEFAULT pour TEXT)
    country VARCHAR(100) DEFAULT 'Morocco',
    full_address TEXT NULL,  -- Pas de DEFAULT pour TEXT
    ...
    guarantor_address TEXT NULL,  -- Pas de DEFAULT pour TEXT
    guarantor_email VARCHAR(255) NULL,
    guarantor_workplace VARCHAR(255) NULL,
    guarantor_workplace_address TEXT NULL,  -- Pas de DEFAULT pour TEXT
    ...
    emergency_address TEXT NULL,  -- Pas de DEFAULT pour TEXT
...
-- 2. Insérer une application de test avec des valeurs explicites
INSERT INTO applications (
    ...
    'User',
    'Morocco',
    'Test Address, Morocco',  -- Valeur explicite pour TEXT
    'DRAFT',
    1,
    'Test Program',
    'Test University',
...
SELECT 'Migration V3 FINAL FIXED completed successfully!' as status;
